...
//@vuese
//Zeigt einen Navigation Drawer auf der linken Bildschirmseite, ein <pre>&lt;router-view&gt;</pre> mit den Sub-Routes "EditProfile", "EditSettings" auf der rechten Seite.
