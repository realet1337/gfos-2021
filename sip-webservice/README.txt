...
a persistence unit "sip-webservicePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sip-webservice\pom.xml":
...
artifact ("sip-webservice.war") is already built. You can build
