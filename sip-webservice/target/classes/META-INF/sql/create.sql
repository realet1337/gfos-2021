...
CREATE TABLE Roles (id INT UNSIGNED AUTO_INCREMENT NOT NULL, group_id INT UNSIGNED NOT NULL, role_name VARCHAR(64) NOT NULL, role_color VARCHAR(7) NOT NULL, administrator BOOLEAN NOT NULL, priority INT UNSIGNED NOT NULL, FOREIGN KEY (group_id) REFERENCES `Groups`(id), PRIMARY KEY (id));
