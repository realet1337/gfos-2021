...
CREATE TABLE ChatMessages (id INT UNSIGNED AUTO_INCREMENT NOT NULL, author_id INT UNSIGNED NOT NULL, chat_id INT UNSIGNED NOT NULL, content TEXT NOT NULL, expires DATETIME, sent DATETIME, FOREIGN KEY (author_id) REFERENCES Users(id), FOREIGN KEY (chat_id) REFERENCES Chats(id), PRIMARY KEY (id));
